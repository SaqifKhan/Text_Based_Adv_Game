...
while True:
    ...
    direction_input = input("Which direction do you want to go? (north, south, east, west)> ")
...
if number_of_gems != 0:
    ...
    while True:
        ...
        prizes = [5, 5, 5, 5, 5, 10, 20, 50, 100, 100, 100, 100, 500, 500, 500, 1000, 10000]
    ...
    print("Disclaimer: To collect your prize, please contact Victoria Chime. Thank you for playing.")